...
- **No depende del cobro**: quien empaca marca *Empacado* y luego *Entregado*, y con eso el
  pedido sale de su pantalla. Si ya estaba pagado o no, es cosa de caja.
...
4. Se marca entregado → sale de Empaque. Se cobra → sale de Caja y queda en el historial.
